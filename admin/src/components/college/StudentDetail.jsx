      ...
      <div className="container mx-auto bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6 p-6 max-h-[60vh] overflow-y-auto">
          ...
          <div>
            ...
            <p className="text-lg dark:text-white">{d.application?.phone_no}</p>
          </div>
          <div>
            <p className="text-gray-600 dark:text-gray-300">Department</p>
            <p className="text-lg dark:text-white">{d.application?.department}</p>
          </div>
          <div>
            <p className="text-gray-600 dark:text-gray-300">CheckIn File</p>
            <button
              onClick={() => viewFile(d.checkin_file[0])}
          ...
          <div>
            ...
            <p className={`text-lg uppercase ${getStatusColor(d.status)}`}>
              {d.status}
            </p>
          </div>
          {/* <div>
